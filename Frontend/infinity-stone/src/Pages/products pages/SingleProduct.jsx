...
const getdata = (id) => {
  return fetch(`https://cartlane.onrender.com/rings/${id}`).then((res) =>
    res.json()
  );
};
...
const slides = [
  {
    url: "https://cdn.caratlane.com/media/catalog/product/cache/6/image/480x480/9df78eab33525d08d6e5fb8d27136e95/J/R/JR03769-YGP900_11_listfront.jpg",
    title: "img1",
  },
  {
    url: "https://cdn.caratlane.com/media/catalog/product/cache/6/image/480x480/9df78eab33525d08d6e5fb8d27136e95/J/R/JR07752-1YP600_11_listfront.jpg",
    title: "img2",
  },
];
...
const slides1 = [
  {
    url: "https://cdn.caratlane.com/media/catalog/product/cache/6/image/480x480/9df78eab33525d08d6e5fb8d27136e95/J/R/JR07525-1YP600_11_listfront.jpg",
    title: "img1",
  },
  {
    url: "https://cdn.caratlane.com/media/catalog/product/cache/6/image/480x480/9df78eab33525d08d6e5fb8d27136e95/J/R/JR04252-YGP900_11_listfront.jpg",
    title: "img2",
  },
];
const slides2 = [
  {
    url: "https://cdn.caratlane.com/media/catalog/product/cache/6/image/480x480/9df78eab33525d08d6e5fb8d27136e95/J/R/JR03647-YGP600_11_listfront.jpg",
    title: "img1",
  },
  {
    url: "https://cdn.caratlane.com/media/catalog/product/cache/6/image/480x480/9df78eab33525d08d6e5fb8d27136e95/J/R/JR07752-1YP600_11_listfront.jpg",
...
const SingleProduct = () => {
  ...
  const handelChangeClick = () => {
    ...
    axios
      .post(
        "https://cartlane.onrender.com/cart/add",
        { title, price, originalprice, size, image, imageurl },
        {
          headers: {
              ...
              <Flex className={Styles.inner_flex}>
                <Box w={"50%"}>
                  <Flex>
                    ...
                    {/* <Spacer/> */}
                    <Text fontSize={"10px"} color={"blue"} marginLeft={"20px"}>
                      Diamond Guide
                    </Text>
                  </Flex>
                  <Select
                    placeholder="14 KT Yellow"
                    width={["30%", "40%", "60%", "70%"]}
                  >
                  ...
                  >
                    <Flex>
                      ...
                      <Box>
                        ...
                        <Text fontSize={"11px"}>
                          Get a live video Call with our Consultants
                        </Text>
                      </Box>
                    </Flex>
                ...
                <Box w={"50%"} pl={5}>
                  <Flex>
                    ...
                    <Text fontSize={"11px"} color={"blue"} marginLeft={"10px"}>
                      Locate me
                    </Text>
                  </Flex>
                  ...
                  <Flex>
                    ...
                    <Box>
                      <Text color={"black"} fontWeight="bold" fontSize={"13px"}>
                        Free Delivery by 10th of May
                      </Text>
                      <Text fontSize={"11px"}>
                        Order in next 17 min and 17 sec
                      </Text>
                    </Box>
                  </Flex>
                  ...
                  >
                    <Flex>
                      ...
                      <Box>
                        ...
                        <Text fontSize={"11px"}>
                          Home Appoinment Available till 27may
                        </Text>
                      </Box>
                    </Flex>
