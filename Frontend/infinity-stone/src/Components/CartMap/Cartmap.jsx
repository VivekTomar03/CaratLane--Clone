...
const Cartmap = ({imageurl, price,originalprice, title, size, HandleCartDelete, id }) => {
  return (
    ...
    <div className="detailsDiv">
      ...
      <p className="pricedetails">
        ...
        <span style={{ fontWeight:"bold", color:"grey"}}>{originalprice}</span>
        <span style={{ fontWeight:"bold", color:"red "}}>Save 4,282</span>
      </p>
      </div>
    ...
    <div className="btnDiv">
      ...
      <button style={{border:"1px solid #9062f9"}}>Move to Wishlist</button>
    </div>
  </div>
  )
    // <div id="mainCart">
